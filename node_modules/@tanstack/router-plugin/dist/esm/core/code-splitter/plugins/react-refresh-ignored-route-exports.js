...
var buildReactRefreshIgnoredRouteExportsStatement = template.statement(`
...
function createReactRefreshIgnoredRouteExportsPlugin() {
	return {
		...
		onAddHmr(ctx) {
			...
			ctx.programPath.pushContainer("body", buildReactRefreshIgnoredRouteExportsStatement({ moduleId: t.stringLiteral(ctx.opts.id) }));
